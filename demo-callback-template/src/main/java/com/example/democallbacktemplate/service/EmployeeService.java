...
public class EmployeeService {
    ...
    public void createEmployee(Employee emp){
        jdbcTemplate.update("""
                ...
                """,emp.getId(),emp.getFirst_name(),emp.getLast_name(),emp.getEmail(),emp.getSalary());
    }
...
//                    }
    ...
    public double avgRollCallBackHandler() {
        CustomRowCallBackHandler rowCalBackHandler = new CustomRowCallBackHandler();
        jdbcTemplate.query("""
                select salary from employee
                """, rowCalBackHandler);
        return rowCalBackHandler.averageSalary();
    }
